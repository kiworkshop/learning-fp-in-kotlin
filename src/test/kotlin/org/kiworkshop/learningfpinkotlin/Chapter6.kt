    ...
    context("P.169 연습 문제") {
        ...
        test("6-3. 연습문제 6-2에서 작성한 insert 코드를 100,000번 이상 연속해서 insert 해보자.") {
            shouldThrowExactly<StackOverflowError> {
                (1..1_000_000_000).fold(EmptyBNode as BinaryTree<Int>) { acc, element ->
                    acc.insert(element)
                }
            }
        }
        ...
        test(
            ...
            val binaryTree = EmptyBNode.insert(4)
                .insert(2)
                .insert(6)
                .insert(1)
                .insert(3)
