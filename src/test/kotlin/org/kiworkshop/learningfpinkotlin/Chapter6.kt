...
class Chapter6 : FunSpec({
    ...
    context("P.169 연습 문제") {
        ...
        xtest("6-3. 연습문제 6-2에서 작성한 insert 코드를 100,000번 이상 연속해서 insert 해보자.") {
            val binaryTree = EmptyNode

            fun insertBy1_000_000_000() {
                for (i in 0..1_000_000_000) {
                    binaryTree.insert(i)
                }
            }

            // stack overflow 발생하지 않음 ㅇㅅㅇ
            shouldThrowExactly<StackOverflowError> { insertBy1_000_000_000() }
        }
