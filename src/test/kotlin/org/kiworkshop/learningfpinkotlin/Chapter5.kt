...
class Chapter5 : StringSpec({
    ...
    "5-2" {
        val list: FunList<Double> = FunList.Cons(1.0, FunList.Cons(2.0, FunList.Cons(3.0, FunList.Cons(4.0, FunList.Cons(5.0, FunList.Nil)))))
    }
    ...
    "5-4" {
        FunList.Nil.appendTail(1).appendTail(2).appendTail(3)
